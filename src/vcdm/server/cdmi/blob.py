...
class Blob(resource.Resource):
    ...
    def render_GET(self, request):
        ...
        status, content, uid, mimetype, metadata = blob.read(self.avatar,fullpath)
    ...
    def render_PUT(self, request):
        ...
        status, uid = blob.write(self.avatar, name, container_path, fullpath, mimetype, metadata, body['value'])
...
class NonCDMIBlob(resource.Resource):
    ...
    def render_GET(self, request):
        ...
        # perform operation on ADT
        status, content, _, mimetype, __ = blob.read(self.avatar, fullpath)        
        # construct response
        request.setResponseCode(status)
