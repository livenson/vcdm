"""
Implementation of the CDMI GUID spec from 
http://cdmi.sniacloud.com/cdmi_spec/5-overview_of_cloud_storage/5-overview_of_cloud_storage.htm#TOC_5_11_CDMI_Object_IDbc-11
"""
...
def generate_guid(entnumber = 0x00FFFFFF):
    """
    entnumber -- Enterprise number, as assigned by IANA: http://www.iana.org/assignments/enterprise-numbers
    """
    # first byte must be 0, so that when it's converted to network byte order, first byte will be left zero too
